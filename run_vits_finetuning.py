...
def main():
    ...
    if os.path.isdir(training_args.output_dir) and training_args.do_train and not custom_args.overwrite_output_dir:
    ...
    logging_dir = os.path.join(training_args.output_dir, training_args.get("logging_dir","logs"))
